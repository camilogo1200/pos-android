...
class ValidateCustomerFirstNameUseCaseImpl @Inject constructor() :
    ValidateCustomerFirstNameUseCase {

    private val nameRegex = Regex("^[A-Za-zÀ-ÿ ]+$")

    override fun invoke(firstName: String): CustomerFieldValidationResult {
        val trimmedValue = firstName.trim()

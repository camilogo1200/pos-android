...
android {
    ...
    defaultConfig {
        ...
        versionCode = 1
        versionName = "1.0"
        buildConfigField("String", "KEYCLOAK_BASE_URL", "\"http://192.168.68.52:18080/\"")
        ...
        buildConfigField("String", "PRODUCTS_BASE_URL", "\"http://192.168.68.52:3000/\"")
        buildConfigField("String", "PRODUCTS_LIST_PATH", "\"products\"")
        buildConfigField("String", "PRODUCTS_CREATE_PATH", "\"products\"")
